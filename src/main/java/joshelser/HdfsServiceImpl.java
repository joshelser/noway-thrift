...
public class HdfsServiceImpl implements HdfsService.Iface {
  ...
  @Override
  public String pause(int millis) throws TException {
    try {
      Thread.sleep(millis);
  ...
  @Override
  public void ls_oneway(String directory) throws TException {
    throw new RuntimeException("Failed!");
  }

  @Override
  public void pause_oneway(int millis) throws TException {
    pause(millis);    
    log.info("finished pause_oneway");
  }
